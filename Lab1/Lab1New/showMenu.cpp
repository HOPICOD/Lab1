...
void ShowTasks_for_input() {
	...
	cout << "4 - load data from the fileexit the program" << endl;
	cout << "5 - get a list of flights for a given destination" << endl;
	cout << "6 - get a list of flights for a given day of the week" << endl;
	cout << "7 - get a list of flights for a given day of the week, the departure time for which is later than the specified one." << endl;
